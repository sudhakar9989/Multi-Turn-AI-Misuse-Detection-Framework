...
st.markdown(
    ...
    <div class="hero-header">
        <div class="hero-title">Multi-Turn AI Misuse Detection Framework</div>
        <div class="hero-subtitle">
            SentinelLoop: Real-time behavioral drift detection, cumulative 5D vector scoring, and dynamic safety interventions.
        </div>
    </div>
    """,
    unsafe_allow_html=True,
